...
class DbOperation
{
    ...
    //This method will return disorders detail
    public function getDisorders($disordername){
        $conn = $this->con;
        $stmt = pg_query_params($conn,"SELECT * FROM disorders");
        $stmt->pg_execute();
        //Getting the student result array
        $disorders = $stmt->pg_get_result()->pg_fetch_assoc();
        $stmt->pg_close();
    ...
    public function createDisorders($id,$disordername,$disorderdesc){
